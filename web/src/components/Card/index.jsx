export const Card = ({timeA, timeB, match}) => (
    <div className='rounded-xl border border-gray-300 p-4 text-center space-y-4'>
        ...
        <div className='flex space-x-4 justify-center items-center'>
            ...
            <img src={`/imgs/flags/${timeA.slug}.png`} alt={timeA.slug} />
            <input max={15} type="number" className='bg-red-300/[0.2] w-12 h-12 text-red-700 text-xl text-center'/>
            <span className='text-red-500 font-bold'>X</span>
            <input max={15} type="number" className='bg-red-300/[0.2] w-12 h-12 text-red-700 text-xl text-center'/>
            <img src={`/imgs/flags/${timeB.slug}.png`} alt={timeB.slug} />
